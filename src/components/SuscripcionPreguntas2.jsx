    ...
    return (
        <div>
            <div className="PreguntasContainer">
                ...
                <a className="PreguntasRespuesta">En nuestro centro hemos abandonado el sistema tradicional de pago por visita para ofrecer un servicio mas completo y un seguimiento más cercano al paciente. 
                ...
                diferentes métodos de análisis de composicion corporal tales como bioimpedancia y antropometría, estudio del somatipo, y un conjunto de módulos formativos totalmente personalizados y adaptados a las necesidades
                ...
                <a className="PreguntasPregunta" >¿Tiene algún tipo de permanencia las diferentes suscripciones?</a>
                <a className="PreguntasRespuesta" >¡En absoluto! En cualquier momento es posible tanto cambiar de un tipo a otro de suscripción como cancelar permamentemente tu suscripción.</a>
                ...
                <a className="PreguntasRespuesta" >La suscripción GOLD permite concertar visitas adicionales, las cuales tienen un coste de 50€ por visita. Te recomendamos que si anticipas
                que necesitaras más de una visita mensual, cambies tu suscripción previamente a PLATINIUM, la cual te saldrá mucho más rentable.</a>
